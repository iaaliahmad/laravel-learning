        ...
        <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="intro-x mt-8">
                    <input type="text" class="intro-x login__input input input--lg border border-gray-300 block" name="name" placeholder="Name">
                    <div class="text-theme-6 mt-2">{{ $errors->first('name') }}</div>
               
                    <input type="text" class="intro-x login__input input input--lg border border-gray-300 block mt-4" name="email" placeholder="Email">
                    <div class="text-theme-6 mt-2">{{ $errors->first('email') }}</div>
                ...
                <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                    ...
                    <a {{ route('login') }} class="button button--lg w-full xl:w-32 text-gray-700 border border-gray-300 dark:border-dark-5 dark:text-gray-300 mt-3 xl:mt-0 align-top">Sign in</a>
                </div>
            </form>
        </div>
    </div>
